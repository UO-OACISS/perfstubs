...
#define PERFSTUBS_TIMER_START(_timer_name) call pstimerstart(_timer_name)
#define PERFSTUBS_TIMER_STOP(_timer_name) call pstimerstop(_timer_name)
#define PERFSTUBS_STATIC_PHASE_START(_phase_name) call call psstaticphasestart(_phase_name)
#define PERFSTUBS_STATIC_PHASE_STOP(_phase_name) call psstaticphasestop(_phase_name)
#define PERFSTUBS_DYNAMIC_PHASE_START(_phase_prefix, _iteration_index) call psdynamicphasestart(_phase_prefix, _iteration_index)
#define PERFSTUBS_DYNAMIC_PHASE_STOP(_phase_prefix, _iteration_index) call psdynamicphasestop(_phase_prefix, _iteration_index)
#define PERFSTUBS_SAMPLE_COUNTER(_name, _value) call pssamplecounter(_name, _value)
#define PERFSTUBS_METADATA(_name, _value) call psmetadata(_name, _value)
