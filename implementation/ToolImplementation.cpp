...
extern "C" void perftool_init(void) { cout << "Tool: perftool_init!" << endl; }
...
extern "C" void perftool_exit(void) { cout << "Tool: perftool_exit!" << endl; }
...
{
    cout << "Tool: perftool_sample_counter " << counter_name << " = " << value
         << endl;
}
